...
const MainFooter = () => {
  return (
    <footer className="footer text-white py-6 px-4 md:px-6">
      <div className="max-w-7xl mx-auto flex flex-col space-y-6 md:space-y-0">
        {/* Top Section */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12">
            <div>
              <ul className="space-y-3 text-center sm:text-left">
                <li><a href="#" className="text-white hover:text-white text-sm uppercase">Docs</a></li>
            ...
            <div>
              <ul className="space-y-3 text-center sm:text-left">
                <li><a href="#" className="text-white hover:text-white text-sm uppercase">About</a></li>
            ...
            <div>
              <ul className="space-y-3 text-center sm:text-left">
                <li><a href="#" className="text-white hover:text-white text-sm uppercase">Company</a></li>
        ...
        {/* Divider */}
        <hr className="border-t border-[#1d2136] w-full my-4" />

        {/* Bottom Section */}
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          {/* Copyright Text */}
          <div className="text-center sm:text-left">
            <p className="text-xs text-gray-400">©2025 propShare. All Rights Reserved.</p>
          </div>

          {/* Social Media Icons */}
          <div className="flex gap-3 mt-4 sm:mt-0">
            <a href="#" className="grayscale hover:grayscale-0 transition-all duration-300">
              <div className="bg-gray-700 rounded-full p-1.5 hover:bg-gray-600">
