  ...
  return (
    <div className="bg-transparent flex justify-center items-center  text-white  py-12">
      <div className="w-full max-w-6xl flex flex-col md:flex-row gap-4">
        ...
        <div 
          className={`relative flex-1 rounded-xl border ${currentStep === 1 ? 'border-pink-500' : 'border-gray-700'} p-6 flex flex-col`}
          data-aos="fade-up"
          data-aos-delay="100"
        >
        ...
        {/* Step 2: Buy Shares */}
        <div 
          className={`relative flex-1 rounded-xl border ${currentStep === 2 ? 'border-[#60CACB]' : 'border-gray-700'} p-6 flex flex-col`}
          data-aos="fade-up"
          data-aos-delay="300"
        >
        ...
        {/* Step 3: Success */}
        <div 
          className={`relative flex-1 rounded-xl border ${currentStep === 3 ? 'border-green-500' : 'border-gray-700'} p-6 flex flex-col`}
          data-aos="fade-up"
          data-aos-delay="500"
        >
